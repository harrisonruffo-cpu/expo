...
- [iOS][Android] Added an `onLayout` prop to `RNHostView`, which reports the size the host was laid out at in the React Native view tree. `Host` already had one. (by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
